...
switch flag,
  ...
  %%%%%%%%%%%%%%%%%%
  case 0,
   [sys,x0,str,ts,Tprevious4]=mdlInitializeSizes;
  ...
  case 3,
     ...
     [sys,Tprevious4]=mdlOutputs(t,x,u,Uth,Ureset,Tprevious4,Trefract);
...
%=============================================================================
%
function [sys,x0,str,ts,Tprevious4]=mdlInitializeSizes
...
sizes.NumOutputs     =3*4;
sizes.NumInputs      =-1;
sizes.DirFeedthrough = 1;
sizes.NumSampleTimes = 1;   % at least one sample time is needed

sys = simsizes(sizes);
Tprevious4=zeros(1,4);
%
...
%=============================================================================
%
function [sys,Tprevious4]=mdlOutputs(t,x,u,Uth,Ureset,Tprevious4,Trefract)
